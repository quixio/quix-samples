...
[This project](https://github.com/quixio/quix-library/tree/main/nodejs/empty){target="_blank"} is an empty template for a website hosted using Node JS Express in the Quix serverless environment.
