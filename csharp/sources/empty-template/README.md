...
[This project](https://github.com/quixio/quix-library/tree/main/csharp/sources/empty-template){target="_blank"} gives an example of how to connect to Kafka and start a new stream with a few "HelloWorld" parameter values.
