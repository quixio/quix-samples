...
[This project](https://github.com/quixio/quix-library/tree/main/csharp/empty){target="_blank"} is an empty template for C# applications in the Quix serverless environment.
