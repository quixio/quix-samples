...
Using [this project](https://github.com/quixio/quix-samples/tree/main/python/sources/Confluent-Kafka), connect to your existing Confluent Kafka topics and stream data to Quix.
