...
class QuixFunction:
    ...
    def set_stream_properties(self):
        ...
        self.stream_writer.properties.name = "Python Sample 99"
        self.stream_writer.properties.location = "/test/location"
        self.stream_writer.properties.metadata["meta"] = "is"
        self.stream_writer.properties.metadata["working"] = "well"
        self.stream_writer.properties.parents.append("testParentId1")
        self.stream_writer.properties.parents.append("testParentId2")
        self.stream_writer.properties.time_of_recording = datetime.datetime.utcnow()
    ...
    def send_parameter_definitions(self):
        ...
        self.stream_writer.parameters \
            .add_definition("param_at_root", "Root Parameter",
                            "This is a root parameter as there is no default location")
        self.stream_writer.parameters.default_location = "/Base/"
        self.stream_writer.parameters.add_definition("string_param",
                                                     "String parameter",
            ...
            .set_range(
            0, 100)
        self.stream_writer.parameters.add_location("/NotBase") \
    ...
    def send_parameter_data_epoch(self):
        ...
        # Set the epoch
        self.stream_writer.parameters.buffer.epoch = datetime.datetime(2018, 1, 1)

        self.stream_writer.parameters.buffer_size = 500
        self.stream_writer.parameters.buffer_size_in_nanoseconds = 5e+9  # 5000 ms
        self.stream_writer.parameters.buffer_timeout = 400
        self.stream_writer.parameters.default_location = "/default"
        self.stream_writer.parameters.buffer.default_tags["Tag1"] = "tag one"
        self.stream_writer.parameters.buffer.default_tags["Tag2"] = "tag two"
        ...
        self.stream_writer.parameters.buffer \
            ...
            .write()  # 2018-01-01 15:05:23 GMT as nanoseconds since unix epoch
