...
[This code sample](https://github.com/quixio/quix-samples/tree/develop/python/sources/MQTT) demonstrates how to consume data from an MQTT broker and publish that data to a Kafka topic.
