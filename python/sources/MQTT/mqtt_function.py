...
from quixstreaming import OutputTopic


class MQTTFunction:

    def __init__(self, topic, mqtt_client: paho.Client, output_topic: OutputTopic):
    ...
    def handle_mqtt_message(self, topic, payload, qos):
        ...
        self.output_topic.get_or_create_stream(str(topic).replace("/", "-")).events \
