...
[This connector](https://github.com/quixio/quix-samples/tree/main/python/sources/AmazonKinesis) allows you to subscribe to AWS Kinesis data and stream it to a Quix topic.
