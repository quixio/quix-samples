...
[This project](https://github.com/quixio/quix-library/tree/main/python/sources/TFL-Bikepoint){target="_blank"} will allow you to connect to the Transport For London (TfL) BikePoint API.
