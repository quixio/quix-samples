...
[This project](https://github.com/quixio/quix-library/tree/main/python/sources/Fraud-Data-Source){target="_blank"} generates fake credit card transaction data, including fraudulent transactions
