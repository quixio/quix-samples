...
- **INFLUXDB3_HOST**: Base URL clients use to reach InfluxDB v3. Include the `http://` scheme and port so the gRPC/Flight client uses plaintext, not TLS on 443. (Default: `http://influxdb3:80`, Required: `True`)
