...
## Tags
In order to tag data saved in InfluxDb, include property `tags` in the payload. Example:
```json
{
    "time": 1716889059000000000,
    "accelerometer-z": 0.037353286838531494,
    "accelerometer-y": -0.0010199724311940371,
    "accelerometer-x": 0.010638444522768258,
    "tags": {
        "session_id": "819c8af8-8b4a-4759-a993-8c971bd91a7e"
    }
}
```
