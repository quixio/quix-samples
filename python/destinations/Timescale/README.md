...
[This project](https://github.com/quixio/quix-library/tree/main/python/destinations/Timescale){target="_blank"} is an example of how to stream data from Quix to a Timescale Database, it handles both parameter and event data.
