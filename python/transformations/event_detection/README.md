...
[This sample code](https://github.com/quixio/quix-samples/tree/develop/python/transformations/Event-Detection) is an example of how to create a simple transformation using Quix.
