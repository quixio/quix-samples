...
def read_stream(stream_consumer: qx.StreamConsumer):
    ...
    stream_producer = producer_topic.create_stream(stream_consumer.stream_id + '-' + os.environ["Quix__Deployment__Name"])
    stream_producer.properties.parents.append(stream_consumer.stream_id)

    # handle the data in a function to simplify the example
    quix_function = PercentageAlert(stream_consumer, stream_producer)
