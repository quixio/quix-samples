...
[This project](https://github.com/quixio/quix-samples/tree/main/python/transformations/Hugging-Face-Model) generates a prediction with a [Hugging Face](https://huggingface.co/) model: 
